const UserHeader = () => {
    ...
    <div class="header m-auto shadow-md bg-white pb-4">
        <div class="content px-content w-10/12 m-auto">
            <!-- subNav -->
            <nav>
            ...
            <nav class="flex justify-between items-center">
                ...
                <form action="" class="flex-center relative w-2/5">
                    ...
                    <input
                        ...
                        class="w-full py-2 px-10 w-full border border-solid border-detail rounded-full"
                        required
                    />
                    <input
                        type="submit"
                ...
                >
                    <li class="flex flex-row justify-between style-navbar font-semibold lg:font-normal">
                        ...
                        <img src="imgs/icon-arrow.svg" alt="" class="lg:hidden" />
                    </li>
                    <li class="flex flex-row justify-between style-navbar font-semibold lg:font-normal">
                        <a href="">CAT FOOD</a>
                        <img src="imgs/icon-arrow.svg" alt="" class="lg:hidden" />
