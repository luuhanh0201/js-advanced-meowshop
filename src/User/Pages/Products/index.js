  ...
  return `
     <div class="content-wraper font-Roboto px-content mx-auto">
                ...
                <div class="text-3xl font-medium text-detail mt-6">
                    Cat Accessories
                    <span class="text-detail2 text-3xl font-normal">(35)</span>
                </div>
                <!-- main product -->
                <main class="grid grid-cols-[auto,1fr] mt-11 gap-24">
                    ...
                    <div class="grid grid-cols-4 gap-x-3.5 gap-y-5">
                        <div class="w-full bg-white rounded-md cursor-pointer shadow-shadow-slide-product relative">
                        ...
                        <div class="w-full bg-white rounded-md cursor-pointer shadow-shadow-slide-product relative">
                            ...
                            <div class="content-product px-3.5 pt-3.5 pb-3">
                                <div class="text-base font-normal">Multi-Angle Cat LED Laser Toy</div>
                                <div class="mt-1 flex flex-row gap-0.5 items-center">
                                    <i class="fa-solid fa-star" style="color: #ffb800"></i>
                                    <i class="fa-solid fa-star" style="color: #ffb800"></i>
                                    <i class="fa-solid fa-star" style="color: #ffb800"></i>
