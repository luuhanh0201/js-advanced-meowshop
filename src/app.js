...
// Admin routes
router.on("/admin", () => { render(() => ComponentsAdmin(HomePage), app) })
router.on("/admin/home", () => { render(() => ComponentsAdmin(HomePage), app) })
router.on("/admin/products", () => { render(() => ComponentsAdmin(ProductPage), app) })
router.on("/admin/product/:id", ({ data }) => { render(() => ComponentsAdmin(() => ProductDetailPage(data)), app) })
