  ...
  useEffect(() => {
    ...
    btnDetails.forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        <div id="toast-notification" class=" animate__animated animate__zoomIn transition-all duration-300 shadow-shadow-slide-product absolute z-50 top-1/4 w-3/5 p-4 text-gray-900 bg-white rounded-lg  dark:bg-gray-800 dark:text-gray-300" role="alert">
